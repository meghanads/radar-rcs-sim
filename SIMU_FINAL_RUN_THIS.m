...
Tsim= 7;      % simulation time in seconds
...
%         
%         
% %         steps=floor(sum(RESULT(1,:))/(C_num+2));
% 
%         k=1;
%         stp=1;
%         for i=2:stp:(steps-1)
%             j=0;
%             stp=1;
%             while(RESULT(1,i+j)~=1)
%                 CHOP2(k,(j+1))=RESULT(2,(i+j));
%                 TMM2(k,(j+1))=RESULT(3,(i+j));
%                 stp=stp+1;
%                 j=j+1;
%             end
%               k=k+1;
